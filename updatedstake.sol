...
contract DojoStake is Staking20Base, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize(
        ...
        __Staking20Base_init(_timeUnit, _rewardToken, _rewardRatioNumerator, _rewardRatioDenominator, _stakingToken, _rewardToken, _withdrawFeeRecipient);
        __Ownable_init();
